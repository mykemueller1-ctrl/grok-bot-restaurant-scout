...
ICP_TIERS = [
    {
        ...
        "job": "Single-owner ops: paper labor cards, weekly schedules, Toast day exports; still photographing paper invoices even when vendors email PDFs",
        "pains": [
            ...
            "weekly phone-photo AP instead of forwarding email invoices",
            "human staple/photograph loop — not a repeatable system",
        ],
        "report_ids": [
            "kitchen-labor-card",
        ...
        "never86_wedge": "Coach email-invoice intake into a repeatable AP system — kill the weekly photo/staple grind; daily leak dollars not enterprise BI",
    },
    {
        "id": "area-leader",
    ...
    },
    {
        ...
        "reports": [
            ...
            },
            {
                ...
                "source": "Preferred: emailed PDF/CSV invoices (Sysco, PFS, beer houses, Northern Lights). As-is pain evidence: phone photos + Register#2 payout↔store receipts",
                "formats": ["email", "pdf", "csv", "photo"],
                "signals": [
                    "vendor",
                    "sku",
                    "qty",
                ...
                "teach_memory": [
                    {
                        ...
                        "as_is": "Phone photos of paper invoices + payout slips stapled to store receipts — human, non-repeatable weekly grind.",
                        "truth": "Distributors already email invoices; operators still print/photograph instead of routing email into a system.",
                        "coach_to": "Forward/auto-route email invoices into Never86 vendor-invoice intake — remove the human photo/staple loop; store cash runs stay exceptional.",
                        "good_looks_like": "Email PDF/CSV invoices land in a repeatable inbox → normalized vendor/sku/qty/amount. Phone photos are teach evidence of pain, not the target workflow.",
    ...
    return {
        ...
        "holy_grail": {
            ...
            "want": [
                ...
                "google sheets links",
                "sales reportings",
                "forwarded email vendor invoices (preferred AP source)",
                "phone photos of vendor invoices (as-is pain evidence only)",
