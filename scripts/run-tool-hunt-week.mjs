...
console.log("active_buy_now: fixtures/tool-hunt/script-draft-franklin-buy-now.json + script-draft-husk-buy-now.json + catalog-sync-*-sandbox.json");
console.log("active_keep_scorer: scripts/score-marketplace-keep.mjs + scripts/score-pain-fixtures.mjs");
console.log("active_sales_dogfood: girl-goat + franklin + miami-michaels-genuine + nashville-husk");
