...
5. **Stay ahead on tools** — read the weekly **Beyond the Hunt** brief (`docs/TOOL-HUNT.md`). Hunt is **best-in-vertical** (buy-now + pain→sales + agent stack) — not sales/labor forecasting. Authenticate Mem0 / Context in **Cursor desktop**; approve Automation + pilots.
