...
```text
Run Beyond the Hunt for Never86 best-in-vertical only: love→buy-now social commerce, pain→sales-lead, Cursor agents/memory/skills/MCP, and vertical rivals (DoorDash Online Ordering, Uber Webshop, Grubhub Direct, Olo Network, Owner, Trenz, Popmenu, Flipdish, Sauce, BentoBox, etc.).
...
Start with: node scripts/run-tool-hunt-week.mjs
