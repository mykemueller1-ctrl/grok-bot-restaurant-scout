...
Rules:
- Prefer **KEEP / commission % / quit marketplace / effective cost statement-math / menu-markup pad (~20%) / own-your-ordering / dual-run discovery / DoorDash Online Ordering 0% direct / per-order platform fees ($0.99/$1.90) / first-party % fees (Owner Flex 5%)** language from owners when framing `complaint_thesis` (see `fixtures/tool-hunt/pain-scan-marketplace-keep.json`, `pain-scan-doordash-effective-cost.json`, `pain-scan-menu-markup.json`, `pain-scan-dual-run.json`, `pain-scan-bentobox-per-order.json`, `pain-scan-owner-pct-fee.json`, `pain-scan-doordash-online-ordering.json`, `pain-to-sales-keep-girl-goat.json`).
