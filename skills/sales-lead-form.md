...
| `suggested_angle` | 1 outreach angle (draft only) — contrast vs Owner email/SMS OS, Popmenu/Sauce/ChowNow/Lunchbox/OPA!/SWIPEBY/Outbites/Orderitto/Seared/Deonde/Flipdish/BentoBox/Toast first-party web-QR/IG ordering, Deliverect/Zyda/ChatFood/BentoBox/Toast/Flipdish/Kyte/Square Online Meta Order Food, DirectOrders/RAY/Mirar/Mando/Orderlya IG DM/WhatsApp, linkboo/NullMark webview-escape bio links (Toast/Square/ChowNow Apple Pay + OpenTable/Resy cookie cliffs), LinkScale bio hubs that still route Uber Eats, BiteSight/Smiilen video marketplace, Menami/TextOrder/FOSA/Palmate/DMHub/Ainisa/Ordr DM agents, OrderPost post→order links, Seekadu reservations, Moast/CheckIt/FeedGrid/SwipeReel Shopify UGC widgets, Seekeasy/Beebz creator discovery, or content-only AI Reels (Feedo/PlateAI) |
| `sources` | URLs |
