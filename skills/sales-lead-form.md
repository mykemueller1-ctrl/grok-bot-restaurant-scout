...
Rules:
- Prefer **KEEP / commission % / quit marketplace / TikTok Shop ~6% referral vs DoorDash 15–30% / effective cost statement-math / menu-markup pad (~20%) / own-your-ordering / dual-run discovery / DoorDash OO·Uber Webshop·Grubhub Direct 0% direct / per-order platform fees ($0.99/$1.90/Otter txn/Popmenu $1/247waiter $0.25 transmission) / guest-paid OO tech fees (DevourNow $2.99 / $1+% / BentoBox QR diner $0.99 / Owner guest 5% support / Popmenu $1) / first-party % fees (Owner Flex 5% / IG checkout 5%)** language from owners when framing `complaint_thesis` (see `fixtures/tool-hunt/pain-scan-marketplace-keep.json`, `pain-scan-doordash-effective-cost.json`, `pain-scan-tiktok-shop-fee.json`, `pain-scan-menu-markup.json`, `pain-scan-dual-run.json`, `pain-scan-bentobox-per-order.json`, `pain-scan-bentobox-guest-fee.json`, `pain-scan-otter-per-order.json`, `pain-scan-247waiter-per-order.json`, `pain-scan-devournnow-guest-fee.json`, `pain-scan-owner-pct-fee.json`, `pain-scan-owner-guest-fee.json`, `pain-scan-popmenu-guest-fee.json`, `pain-scan-doordash-online-ordering.json`, `pain-to-sales-keep-girl-goat.json`).
