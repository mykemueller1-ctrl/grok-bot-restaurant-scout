...
- Vertical rivals: Owner, Trenz, Restomas, Feedia, BrandPal, CreatOK, Straunt, Zayos, TextOrder, Menami, Seekadu, Klikit (APAC+US), Deliverect/Zyda/ChatFood/BentoBox/Toast/Flipdish/Kyte/Square Online (IG Order Food), DirectOrders/RAY (IG DM), BiteSight/Smiilen (video marketplace), linkboo (webview escape), OrderPost, Beebz, Seared, Moast, Ainisa, similar
