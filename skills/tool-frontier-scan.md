...
- Vertical rivals: Owner, Trenz, Restomas, Feedia, BrandPal, CreatOK, Straunt, Zayos, TextOrder, Menami, Seekadu, Klikit (APAC+US), Deliverect (IG Order Food), BiteSight (video marketplace), linkboo (webview escape), OrderPost, Beebz, Seared, Moast, Ainisa, similar
